...
export class NullableDomainId1762880337855 implements MigrationInterface {
    name = 'NullableDomainId1762880337855';
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`requests\` CHANGE \`domain_id\` \`domain_id\` int NULL
        `);
        await queryRunner.query(`
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        `);
        await queryRunner.query(`
            ALTER TABLE \`requests\` CHANGE \`domain_id\` \`domain_id\` int NOT NULL
        `);
        await queryRunner.query(`
