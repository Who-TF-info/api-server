...
import type { DomainEntity } from '@app/database/entities/DomainEntity';
import type { DomainLookupEntity } from '@app/database/entities/DomainLookupEntity';
import type { DomainNameEntity } from '@app/database/entities/DomainNameEntity';
import type { RequestEntity } from '@app/database/entities/RequestEntity';
import type { TopLevelDomainEntity } from '@app/database/entities/TopLevelDomainEntity';
...
import type { CreateDomainLookupDto, CreateRequestDto } from '@who-tf-info/shared';
